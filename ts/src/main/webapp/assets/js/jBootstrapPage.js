		...
		return this
				.each(function() {
					...
					function init() {
						...
						$this
								.append('<li class="disabled"><a class="first" href="#">&laquo;</a></li>');
						$this
								.append('<li class="disabled"><a class="pre" href="#">上一页</a></li>');
						...
						$this
								.append('<li class="disabled"><a class="next" href="#">下一页</a></li>');
						$this
								.append('<li><a class="last" href="#">&raquo;</a></li>');

						if (c.maxPageButton >= c.maxPages) {
							$this.find('li a.next').parent().addClass(
									"disabled");
							$this.find('li a.last').parent().addClass(
									"disabled");
						} else {
							$this.find('li a.next').parent().removeClass(
									"disabled");
							$this.find('li a.last').parent().removeClass(
									"disabled");
						}
					...
					function mathNextPage(currButtonNum, currPage, maxPage,
						...
						/*
						 * if((currButtonNum != currPage+1 || maxPage >
						 * showPage) && currButtonNum > middle) { var startPages =
						 * currPage - middle + offsetRight;
						 * 
						 * var endPages = currPage + middle + offsetRight;
						 * endPages = endPages > maxPage ? maxPage : endPages;
						 * 
						 * if(endPages < c.maxPageButton) endPages =
						 * c.maxPageButton;
						 * 
						 * if(endPages - startPages > c.maxPageButton) { var d =
						 * endPages - startPages - c.maxPageButton; endPages -=
						 * d; }
						 * 
						 * if(endPages - startPages < c.maxPageButton) { var d =
						 * c.maxPageButton - (endPages - startPages); startPages -=
						 * d; }
						 * 
						 * var pNum = 0; var html = ''; for(var index =
						 * startPages; index < endPages; index++) { pNum++; html += '<li class="page" pNum="'+pNum+'"><a
